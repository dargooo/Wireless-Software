...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHistory = (Button)findViewById(R.id.btnView);
        ...
        btnSummary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent activityIntent = new Intent(MainActivity.this, SummaryActivity.class);
                Bundle newActivityInfo = new Bundle();
                newActivityInfo.putDouble("summary", 4.4);  // putDouble, putString, etc.
                activityIntent.putExtras(newActivityInfo);
                startActivity(activityIntent);
            }
        });
        ...
        btnChart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent activityIntent = new Intent(MainActivity.this, ChartActivity.class);
                Bundle newActivityInfo = new Bundle();
                newActivityInfo.putDouble("chart", 5.5);  // putDouble, putString, etc.
                activityIntent.putExtras(newActivityInfo);
                startActivity(activityIntent);
            }
        });
